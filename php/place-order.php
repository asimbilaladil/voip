...
//$curpageArr=end(explode("place-order.php",$curpage));print_r($curpageArr);
//$_SERVER['SERVER_NAME'].$curpageArr[1]."/"."thankyou.php";
    	...
    	<div class="banner-area inner-banner-area">
            ...
            <div class="top-area">
                ...
                <div class="container">
                	...
                	<a href="index.html" class="inner-logo"><img src="img/logo-main.png" alt=""></a>
