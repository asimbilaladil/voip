                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td><?php echo $optionslist[$opt]['optionname'];?></td>

                                            <td ><?php echo $optionslist[$opt]['optionPrice'];?></td>

                                            <td >

                                            <a href="optionedit.php?id=<?php echo base64_encode($optionslist[$opt]['idOption']);?>">
                                            ...
                                            <a href="optionlist.php?act=del&id=<?php echo base64_encode($optionslist[$opt]['idOption']);?>">
